...
INSERT INTO tb_morador (id, nome, cpf, data_nascimento, celular, email, contatos_familia, senha, role) VALUES (1, 'Emmanuel Diniz Cheroto', '12345678900', DATE '2000-01-15', '31999990000', 'emmanuel@example.com', '(31)98888-7777', '$2a$12$BtpWor8lSLj2hud9G30m1.XkrgWH.TUHOoEcMlQBKNuL.Nbd5O4B2', 'ADMIN');

INSERT INTO tb_morador (id, nome, cpf, data_nascimento, celular, email, contatos_familia, senha, role) VALUES (2, 'Gustavo Gusmão', '09876543211', DATE '2001-03-20', '31911112222', 'gustavo@example.com', '(31)92222-3333', '$2a$12$BtpWor8lSLj2hud9G30m1.XkrgWH.TUHOoEcMlQBKNuL.Nbd5O4B2', 'USER');
